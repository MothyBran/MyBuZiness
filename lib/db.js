...
export async function initDb() {
  ...
  try {
    ...
    await client.query(`
      -- Produktfelder erweitern
      ALTER TABLE "Product"
      ADD COLUMN IF NOT EXISTS "kind" TEXT NOT NULL DEFAULT 'service', -- 'service' | 'product'
      ADD COLUMN IF NOT EXISTS "categoryCode" TEXT,                     -- z.B. '1.1', '2.3'
      ADD COLUMN IF NOT EXISTS "travelEnabled" BOOLEAN NOT NULL DEFAULT FALSE,
      ADD COLUMN IF NOT EXISTS "travelRateCents" INTEGER NOT NULL DEFAULT 0, -- Preis pro km (in Cent)
      ADD COLUMN IF NOT EXISTS "travelUnit" TEXT NOT NULL DEFAULT 'km';      -- 'km' (später erweiterbar)
    `);
